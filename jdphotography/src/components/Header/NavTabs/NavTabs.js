...
function NavTabs() {
    ...
    return (<div>
        ...
        <Navbar bg="dark" variant="dark" expand="l" id="nav-data" style={{ position: "fixed", zIndex: 1, width: '100%', top: '0' }}>
            ...
            {/* <Navbar.Toggle aria-controls="basic-navbar-nav" onClick={handleShow}>Menu</Navbar.Toggle> */}
            <button onClick={handleShow} aria-controls="basic-navbar-nav" type="button" aria-label="Toggle navigation" className="navbar-toggler">Menu<span className="navbar-toggler-icon"></span></button>
            ...
            <Offcanvas.Body style={{ display: 'grid', backgroundColor: 'rgba(25, 25, 25, 1)', color: 'orange' }}>
                <Nav className="justify-content-center" activeKey="/">
                    <pre className="pre-links" >
                        {/* <Nav.Link href="/home"><span id="nav-link-text">Home</span></Nav.Link> */}
                        <Link to="/home" onClick={handleClose}><span id="nav-link-text">Home</span></Link>
                        <hr />
                        {/* <Nav.Link href="#/about"><span id="nav-link-text">About</span></Nav.Link> */}
                        <Link to="/about" onClick={handleClose}><span id="nav-link-text">About</span></Link>
                        <hr />
                        {/* <Nav.Link href="/contact"><span id="nav-link-text">Contact</span></Nav.Link> */}
                        <Link to="/contact" onClick={handleClose}><span id="nav-link-text">Contact</span></Link>
                        <hr />
                        {/* <Nav.Link href="/hoodies"><span id="nav-link-text">Hoodies</span></Nav.Link> */}
                        <Link to="/hoodies" onClick={handleClose}><span id="nav-link-text">Hoodies</span></Link>
                        <hr />
                        {/* <Nav.Link href="/#/hats"><span id="nav-link-text">Hats</span></Nav.Link> */}
                        <Link to="/hats" onClick={handleClose}><span id="nav-link-text">Hats</span></Link>
                        <hr />
                        {/* <Nav.Link href="/#/shirts"><span id="nav-link-text">Shirts</span></Nav.Link> */}
